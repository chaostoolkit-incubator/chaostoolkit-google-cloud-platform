...
def apphub_app_list_services(project_id, location, application_id):
...
def get_url_map_essentials(project_id):
...
def url_map_exists(url_map_value, project_id, region, application_name):
